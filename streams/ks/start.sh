...
# 	echo -e "${C}Start of router p${provider}r${first_router}v executed successfully!${NC}"
# else
# 	echo -e "${C}Start of routers p${provider}r${first_router}v to p${provider}r${last_router}v executed successfully!${NC}"
# fi